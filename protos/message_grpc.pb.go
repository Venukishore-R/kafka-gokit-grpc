...
const (
	...
	MessageService_ConsumeMessage_FullMethodName = "/MessageService/ConsumeMessage"
)
...
func (c *messageServiceClient) SendMessage(ctx context.Context, in *ProducerMessageReq, opts ...grpc.CallOption) (*ProducerMessageResp, error) {
	out := new(ProducerMessageResp)
...
func _MessageService_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MessageServiceServer).SendMessage(ctx, req.(*ProducerMessageReq))
	}
...
func _MessageService_ConsumeMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MessageService_ConsumeMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
